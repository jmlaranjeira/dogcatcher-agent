...
class DatadogConfig(BaseSettings):
    ...
    service: str = Field("myservice", env="DATADOG_SERVICE", description="Service name filter")
...
class Config(BaseSettings):
    ...
    datadog_service: str = Field("myservice", env="DATADOG_SERVICE", description="Service name filter")
