...
class Config(BaseSettings):
    ...
    def validate_configuration(self) -> List[str]:
        ...
        if self.jira.similarity_threshold < 0.5:
    ...
    def log_configuration(self) -> None:
        ...
        log_info("Configuration loaded", 
                ...
                datadog_site=self.datadog.site,
                datadog_service=self.datadog.service,
                datadog_env=self.datadog.env,
                jira_project=self.jira.project_key,
                auto_create=self.agent.auto_create_ticket,
                max_tickets=self.agent.max_tickets_per_run,
                similarity_threshold=self.jira.similarity_threshold,
